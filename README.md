...
| [free-claude-code](https://github.com/Alishahryar1/free-claude-code) | https://github.com/Alishahryar1/free-claude-code | Starred | Use Claude Code, Codex and Pi for free from your terminal, IDE, and phone like OpenClaw (voice supported) |
...
| [ruflo](https://github.com/ruvnet/ruflo) | https://github.com/ruvnet/ruflo | Starred | 🌊 The leading agent meta-harness. Deploy intelligent multi-player swarms, coordinate autonomous workflows, and build conversational AI systems. Features adaptive memory, self-learning intelligence, RAG integration, and native Claude Code / Codex / Hermes and many more Integrated |
