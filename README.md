...
| [ministack](https://github.com/ministackorg/ministack) | https://github.com/ministackorg/ministack | Starred | Ministack: Free, open-source local AWS emulator - 55+ services, Terraform compatible, real databases. Free forever. MIT   licensed. |
...
| [OmniVoice-Studio](https://github.com/debpalash/OmniVoice-Studio) | https://github.com/debpalash/OmniVoice-Studio | Starred | Local voice clone, video dubbing, dictation and audiobook maker. The open-source ElevenLabs alternative. |
| [open-code-review](https://github.com/alibaba/open-code-review) | https://github.com/alibaba/open-code-review | Starred | Open-source & free — Battle-tested at Alibaba's scale. Hybrid architecture code review tool: deterministic pipelines + LLM Agent, precise line-level comments, built-in multi-language ruleset (NPE, thread-safety, XSS, SQL injection), OpenAI & Anthropic compatible. |
