...
| [auditkit](https://github.com/Danilaa1/auditkit) | https://github.com/Danilaa1/auditkit | Starred | Local hybrid CLI for agency website audits.  Rust runs the core workflow: audit folders, quick HTML checks, security checks, and report generation. Node is used only for Lighthouse. |
...
| [maigret](https://github.com/soxoj/maigret) | https://github.com/soxoj/maigret | Starred | 🕵️‍♂️ Collect a dossier on a person by username from 3000+ sites |
