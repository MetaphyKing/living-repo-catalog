...
| [codegraph](https://github.com/colbymchenry/codegraph) | https://github.com/colbymchenry/codegraph | Starred | Pre-indexed code knowledge graph for Claude Code, Codex, Gemini, Cursor, OpenCode, AntiGravity, Kiro, and Hermes Agent — fewer tokens, fewer tool calls, 100% local |
...
| [orca](https://github.com/stablyai/orca) | https://github.com/stablyai/orca | Starred | Orca is the next-gen ADE for working with a fleet of parallel agents. Run any coding agent with your own subscription. Available on desktop and mobile. |
